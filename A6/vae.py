...
class VAE(nn.Module):
    def __init__(self, input_size, latent_size=15):
        ...
        self.hidden_dim = 128  # H_d - PYSKINAS: Not sure what this value is meant to be, so I'll use 128
        self.encoder = None
        self.mu_layer = None
...
def loss_function(x_hat, x, mu, logvar):
    ...
    rlt = F.binary_cross_entropy(x_hat, x, reduction="sum")

    # KL divergence
    d = -0.5*torch.sum(1 + logvar - mu**2 - torch.exp(logvar))
